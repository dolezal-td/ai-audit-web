...
<div className="flex gap-4">
  ...
  <div>
    <p className="font-black text-2xl mt-0 mb-2 leading-tight">ChatGPT používáte jako vyhledávač – ale umí mnohem víc.</p>
...
<div className="flex gap-4">
  ...
  <div>
    <p className="font-black text-2xl mt-0 mb-2 leading-tight">AI jste zkoušeli, narazili a vyvodili špatné závěry.</p>
...
<div className="flex gap-4">
  ...
  <div>
    <p className="font-black text-2xl mt-0 mb-2 leading-tight">Oddělení je nejslabší v celém JTRE – a výrazně pod trhem.</p>
...
<div className="flex gap-4">
  ...
  <div>
    <p className="font-black text-2xl mt-0 mb-2 leading-tight">Cashflow, stanoviska a výkresy vás stojí desítky člověkodní ročně.</p>
...
<div className="flex gap-4">
  ...
  <div>
    <p className="font-black text-2xl mt-0 mb-2 leading-tight">Máte ambasadory, kteří to můžou táhnout – ale potřebují strukturu.</p>
