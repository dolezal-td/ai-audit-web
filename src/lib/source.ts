import { jtreFinance, jtreObchod, jtreProjektoveRizeni, euroinstitut, demo } from '@/.source/server';
...
export const euroinstitutSource = loader({
  source: euroinstitut.toFumadocsSource(),
  baseUrl: '/euroinstitut',
});
